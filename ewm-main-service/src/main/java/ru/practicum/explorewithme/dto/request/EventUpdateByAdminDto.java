...
/**
 * Данные для обновления события администратором.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@ToString
@Schema(description = "Данные для обновления события администратором")
public class EventUpdateByAdminDto {
     ...
     */
    @Schema(description = "Изменение состояния события (PUBLISH_EVENT или REJECT_EVENT)")
